...
4. **Build Function**: A function that returns the list of rules (see examples for naming conventions)
...
The rule-building function can have any of these names (the loader will try them in order):
- `build_{project_name}_rules` (e.g., `build_myproject_rules`)
- `build_{project_name}` (e.g., `build_myproject`)
- `build_custom_rules`
- `build_rules`
- `{project_name}_rules` (e.g., `myproject_rules`)
- `rules`
...
1. [custom_rules_example.py](examples/custom_rules_example.py) - General custom rules example (function: `build_custom_rules`)
2. [web_project_rules.py](examples/web_project_rules.py) - Web project specific rules example (function: `build_web_dev_rules`)
3. [myproject_rules.py](examples/myproject_rules.py) - Template for creating your own project rules (function: `build_myproject_rules`)
