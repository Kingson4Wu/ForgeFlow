...
class MockCLIAdapter:
    ...
    def is_task_processing(self, history: list):
        # New signature: history-based. Check last frame's output against processing_outputs
        current = history[-1] if history else ""
        return current in self.processing_outputs
