...
def test_next_command_with_post_processing_logging() -> None:
    ...
    from forgeflow.core.rules.base import get_command_post_processor
    ...
    try:
        ...
        # Patch the function
        import forgeflow.core.rules.base

        forgeflow.core.rules.base.get_command_post_processor = mock_get_processor
        ...
        forgeflow.core.rules.base.get_command_post_processor = original_get_processor
