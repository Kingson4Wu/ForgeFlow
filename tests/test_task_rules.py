...
def test_check_all_tests_passed():
    ...
    assert check_all_tests_passed("10 tests passed")
    assert check_all_tests_passed("Ran 5 tests, all passed")
    assert check_all_tests_passed("OK (tests=20)")
...
def test_check_coverage_below_threshold():
    ...
    assert check_coverage_below_threshold("Coverage is low", 80)
...
def test_check_task_completed():
    ...
    assert check_task_completed("I have finished the task", config)
